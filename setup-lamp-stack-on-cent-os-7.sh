...
if [ "$isCentOs7" == true ]
then
    sudo wget -N http://dl.iuscommunity.org/pub/ius/stable/CentOS/7/x86_64/ius-release-1.0-15.ius.centos7.noarch.rpm
    sudo rpm -Uvh ius-release*.rpm
else
    # Please note that v6.5, 6.4, etc. are all covered by the following repository:
    sudo wget -N http://dl.iuscommunity.org/pub/ius/stable/CentOS/6/x86_64/ius-release-1.0-15.ius.centos7.noarch.rpm
    sudo rpm -Uvh ius-release*.rpm
fi
...
cp adminer-4.3.1.php /var/www/html
mv /var/www/html/adminer-4.3.1.php /var/www/html/adminer.php
